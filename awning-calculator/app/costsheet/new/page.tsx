...
function CostSheetForm() {
  ...
  // Markup is stored as cost divisor (e.g., 0.8 means cost is 80% of price = 20% profit)
  // Formula: Selling Price = Cost / Divisor
  // Example: $100 cost ÷ 0.8 = $125 selling price ($25 profit = 20% of $125)
  const totalWithMarkup = markup > 0 && markup <= 1
    ? subtotalBeforeMarkup / markup
              ...
              <div className="sticky top-4 space-y-4">
                ...
                <div className={cardClass}>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">Fab. Labor:</span><span className="text-gray-900 dark:text-white">{formatCurrency(totalFabricationLabor)} <span className="text-yellow-600 dark:text-yellow-400 text-xs">({fabLaborPct.toFixed(1)}%)</span></span></div>
                    <div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">Install Labor:</span><span className="text-gray-900 dark:text-white">{formatCurrency(totalInstallationLabor)} <span className="text-yellow-600 dark:text-yellow-400 text-xs">({installLaborPct.toFixed(1)}%)</span></span></div>
