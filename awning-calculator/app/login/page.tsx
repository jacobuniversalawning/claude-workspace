    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Universal Awning</h1>
          <p className="text-lg text-gray-400">Cost Sheet Calculator</p>
        </div>
        ...
        <div className="bg-white dark:bg-brand-surface-black rounded-xl shadow-2xl border border-gray-200 dark:border-brand-border-subtle p-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white text-center mb-2">Welcome Back</h2>
          <p className="text-gray-600 dark:text-gray-400 text-center mb-8">Sign in with your Google account to continue</p>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} Universal Awning & Canopy</p>
        </div>
      </div>
    </div>
  );
